...
module.exports = Generator.extend({
    ...
    configuring: function()
    {
        ...
        var jsPath = _.get(this.options, 'js-path') || (projectPath + '/' + path.join(srcPath, 'js'));
        var cssPath = _.get(this.options, 'css-path') || (projectPath + '/' + path.join(srcPath, 'css'));
    ...
    writing:
    {
        html: function()
        {
            ...
            var srcPath = this.templatePath(path.join(projectPath, 'index.html'));
            var destPath = this.destinationPath(path.join(projectPath, 'src/index.html'));
