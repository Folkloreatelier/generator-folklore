        ...
        get: function get() {
            return {
                ...
                webpack: function webpack() {
                    ...
                    var distEntries = getWebpackEntries(_lodash2.default.get(this.options, 'webpack-dist-entry', null), _lodash2.default.get(this.options, 'webpack-dist-entries', []));
        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.yarnInstall(['autoprefixer@latest', 'babel-core@latest', 'babel-loader@latest', 'babel-register@latest', 'babel-plugin-dynamic-import-node@latest', 'babel-plugin-syntax-dynamic-import@latest', 'babel-plugin-transform-es2015-spread@latest', 'babel-plugin-transform-object-rest-spread@latest', 'babel-plugin-transform-class-properties@latest', 'babel-plugin-transform-runtime@latest', 'babel-preset-env@latest', 'babel-preset-react@latest', 'brfs@latest', 'browser-sync@latest', 'bs-fullscreen-message@latest', 'concurrently@latest', 'commander@latest', 'css-loader@latest', 'cssnano@latest', 'customizr@latest', 'expose-loader@latest', 'extract-text-webpack-plugin@latest', 'html-loader@latest', 'imagemin-cli@latest', 'imagemin-mozjpeg@latest', 'imagemin-pngquant@latest', 'imports-loader@latest', 'json-loader@latest', 'node-sass@latest', 'postcss-cli@latest', 'postcss-loader@latest', 'pretty-bytes@latest', 'proxy-middleware@latest', 'raw-loader@latest', 'transform-loader@latest', 'sass-loader@latest', 'serve-static@latest', 'strip-ansi@latest', 'style-loader@latest', 'svg-react-loader@latest', 'webpack@latest', 'webpack-dev-middleware@latest', 'webpack-merge@latest'], {
                        dev: true
                    });
