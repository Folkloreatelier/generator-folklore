...
var _getWebpackEntries = require('./lib/getWebpackEntries');

var _getWebpackEntries2 = _interopRequireDefault(_getWebpackEntries);

var _formatWebpackEntries = require('./lib/formatWebpackEntries');

var _formatWebpackEntries2 = _interopRequireDefault(_formatWebpackEntries);
...
module.exports = function (_Generator) {
    ...
    function AppGenerator() {
        ...
        _this.option('webpack-dev-entry', {
            type: String
        });
        ...
        _this.option('webpack-dist-entry', {
            type: String
        });
        ...
        get: function get() {
            return {
                ...
                postcssConfig: function postcssConfig() {
                    if (!_lodash2.default.get(this.options, 'scss', false) && !_lodash2.default.get(this.options, 'postcss', false)) {
                        return;
                    }
                ...
                webpack: function webpack() {
                    ...
                    var jsDestPath = _lodash2.default.get(this.options, 'js-dest-path', null) || _path2.default.join(destPath, jsPath);
                    var devContext = _lodash2.default.get(this.options, 'webpack-dev-context', null);
                    var publicPath = _lodash2.default.get(this.options, 'webpack-public-path', null) || '/';
                    var entries = (0, _getWebpackEntries2.default)(_lodash2.default.get(this.options, 'webpack-entry', null), _lodash2.default.get(this.options, 'webpack-entries', []));
                    var distEntries = (0, _getWebpackEntries2.default)(_lodash2.default.get(this.options, 'webpack-dist-entry', null), _lodash2.default.get(this.options, 'webpack-dist-entries', null));
                    var devEntries = (0, _getWebpackEntries2.default)(_lodash2.default.get(this.options, 'webpack-dev-entry', null), _lodash2.default.get(this.options, 'webpack-dev-entries', null));
                    if (this.options['webpack-hot-reload']) {
                        if (typeof devEntries === 'undefined' || devEntries === null) {
                            devEntries = _lodash2.default.clone(entries);
                        }
                        var hotReloadEntries = ['react-hot-loader/patch', 'webpack/hot/dev-server', 'webpack-hot-middleware/client?reload=true'];
                        if (_lodash2.default.isObject(devEntries)) {
                            var firstKey = Object.keys(devEntries)[0];
                            var value = devEntries[firstKey];
                            devEntries[firstKey] = [].concat(hotReloadEntries, _toConsumableArray(!_lodash2.default.isArray(value) ? [value] : value));
                        } else if (_lodash2.default.isString(devEntries) || _lodash2.default.isArray(devEntries)) {
                            devEntries = [].concat(hotReloadEntries, _toConsumableArray(!_lodash2.default.isArray(devEntries) ? [devEntries] : devEntries));
                        }
                    }
                    ...
                    var templateData = {
                        ...
                        entries: entries,
                        entriesFormatted: (0, _formatWebpackEntries2.default)(entries),
                        distEntries: distEntries,
                        distEntriesFormatted: (0, _formatWebpackEntries2.default)(distEntries),
                        devEntries: devEntries,
                        devEntriesFormatted: (0, _formatWebpackEntries2.default)(devEntries)
                    };
                ...
                packageJSONScripts: function packageJSONScripts() {
                    ...
                    if (_lodash2.default.get(this.options, 'scss')) {
                        var postcssConfigFile = _path2.default.join(buildPath, 'postcss.config.js');
                        ...
                        scripts['postcss:dist'] = 'postcss -c ' + postcssConfigFile + ' -d ' + scssDestPath + ' ' + _path2.default.join(scssTmpPath, '/**/*.css');
        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.npmInstall(['autoprefixer@latest', 'babel-core@latest', 'babel-loader@latest', 'babel-register@latest', 'babel-plugin-dynamic-import-node@latest', 'babel-plugin-syntax-dynamic-import@latest', 'babel-plugin-transform-es2015-spread@latest', 'babel-plugin-transform-object-rest-spread@latest', 'babel-plugin-transform-class-properties@latest', 'babel-plugin-transform-runtime@latest', 'babel-preset-env@latest', 'babel-preset-react@latest', 'brfs@latest', 'browser-sync@latest', 'bs-fullscreen-message@latest', 'concurrently@latest', 'commander@latest', 'css-loader@latest', 'cssnano@latest', 'customizr@latest', 'expose-loader@latest', 'extract-text-webpack-plugin@latest', 'html-loader@latest', 'imagemin-cli@latest', 'imagemin-mozjpeg@latest', 'imagemin-pngquant@latest', 'imagemin-svgo@latest', 'imports-loader@latest', 'json-loader@latest', 'node-sass@latest', 'postcss-cli@latest', 'postcss-loader@latest', 'pretty-bytes@latest', 'proxy-middleware@latest', 'raw-loader@latest', 'transform-loader@latest', 'sass-loader@latest', 'serve-static@latest', 'strip-ansi@latest', 'style-loader@latest', 'file-loader@latest', 'url-loader@latest', 'svg-react-loader@latest', 'webpack@latest', 'webpack-dev-middleware@latest', 'webpack-merge@latest'], {
                        saveDev: true
                    });

                    if (this.options['webpack-html']) {
                        this.npmInstall(['autoprefixer@latest'], {
                            saveDev: true
                        });
                    }

                    if (this.options['webpack-hot-reload']) {
                        this.npmInstall(['webpack-hot-middleware@latest', 'react-hot-loader@^3.0.0-beta.7'], {
                            saveDev: true
                        });
                    }
                },
