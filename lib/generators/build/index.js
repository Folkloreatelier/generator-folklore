...
module.exports = function (_Generator) {
    ...
    function AppGenerator() {
        ...
        _this.option('webpack-config-build', {
            type: Boolean,
            defaults: true
        });
        ...
        _this.option('webpack-config-build-path', {
            type: String
        });

        _this.option('webpack-config-browsersync-path', {
            type: String
        });
            ...
            return {
                config: function config() {
                    ...
                    var templateData = {
                        ...
                        browserSyncBaseDir: _lodash2.default.isArray(browserSyncBaseDir) ? browserSyncBaseDir : [browserSyncBaseDir],
                        browserSyncFiles: _lodash2.default.isArray(browserSyncFiles) ? browserSyncFiles : [browserSyncFiles],
                ...
                postcss: function postcss() {
                    ...
                    var destPath = this.destinationPath(_path2.default.join(buildPath, 'postcss.js'));
                    this.fs.copyTpl(srcPath, destPath, templateData);
                },
                ...
                webpack: function webpack() {
                    ...
                    var entries = _lodash2.default.get(this.options, 'webpack-entry', []);
                    ...
                    if (_lodash2.default.get(this.options, 'webpack-config-build')) {
                        configSrcPath = _lodash2.default.get(this.options, 'webpack-config-build-path') || this.templatePath('webpack.config.build.js');
                        configDestPath = this.destinationPath(_path2.default.join(buildPath, 'webpack.config.build.js'));
                        this.fs.copyTpl(configSrcPath, configDestPath, templateData);
                    }

                    if (this.options.browsersync && _lodash2.default.get(this.options, 'webpack-config-browsersync')) {
                        configSrcPath = _lodash2.default.get(this.options, 'webpack-config-browsersync-path') || this.templatePath('webpack.config.browsersync.js');
                        configDestPath = this.destinationPath(_path2.default.join(buildPath, 'webpack.config.browsersync.js'));
                        this.fs.copyTpl(configSrcPath, configDestPath, templateData);
                    }
                },
                packageJSONScripts: function packageJSONScripts() {
                    ...
                    if (_lodash2.default.get(this.options, 'js')) {
                        var webpackConfigFile = _path2.default.join(buildPath, 'webpack.config.build.js');
                        var jsPath = _lodash2.default.get(this.options, 'js-path', 'js');
                        var jsSrcPath = _lodash2.default.get(this.options, 'js-src-path', null) || _path2.default.join(srcPath, jsPath);
        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.npmInstall(['autoprefixer@latest', 'babel-core@latest', 'babel-loader@latest', 'babel-plugin-transform-class-properties@latest', 'babel-preset-es2015@latest', 'babel-preset-react@latest', 'babel-preset-stage-0@latest', 'brfs@latest', 'browser-sync@latest', 'bs-fullscreen-message@latest', 'concurrently@latest', 'commander@latest', 'css-loader@latest', 'cssnano@latest', 'customizr@latest', 'expose-loader@latest', 'html-loader@latest', 'imagemin-cli@latest', 'imports-loader@latest', 'json-loader@latest', 'node-sass@latest', 'postcss-cli@latest', 'proxy-middleware@latest', 'raw-loader@latest', 'transform-loader@latest', 'sass-loader@latest', 'serve-static@latest', 'strip-ansi@latest', 'style-loader@latest', 'svg-react-loader@latest', 'webpack@latest', 'webpack-dev-middleware@latest'], {
                        saveDev: true
                    });
                },
                sass: function sass() {
