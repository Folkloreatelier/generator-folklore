...
module.exports = function (_Generator) {
    ...
    function AppGenerator() {
        ...
        _this.option('webpack-config-prod', {
            type: Boolean,
            defaults: true
        });
        ...
        _this.option('webpack-config-prod-path', {
            type: String
        });
        ...
        get: function get() {
            return {
                ...
                webpack: function webpack() {
                    ...
                    if (_lodash2.default.get(this.options, 'webpack-config-prod')) {
                        configSrcPath = _lodash2.default.get(this.options, 'webpack-config-prod-path') || this.templatePath('webpack.config.prod.js');
                        configDestPath = this.destinationPath(_path2.default.join(buildPath, 'webpack.config.prod.js'));
                        this.fs.copyTpl(configSrcPath, configDestPath, templateData);
                    }
