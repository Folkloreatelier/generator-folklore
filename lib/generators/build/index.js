...
var formatWebpackEntries = function formatWebpackEntries(entries) {
    ...
    if (_lodash2.default.isArray(entries)) {
        ...
        lines.push(tab(2) + '],');
    } else if (_lodash2.default.isObject(entries)) {
        lines.push('entry: {');
        ...
        get: function get() {
            return {
                ...
                webpack: function webpack() {
                    ...
                    var entries = getWebpackEntries(_lodash2.default.get(this.options, 'webpack-entry', null), _lodash2.default.get(this.options, 'webpack-entries', []));
                    var distEntries = getWebpackEntries(_lodash2.default.get(this.options, 'webpack-dist-entry', null), _lodash2.default.get(this.options, 'webpack-dist-entries', null));
                    var devEntries = getWebpackEntries(_lodash2.default.get(this.options, 'webpack-dev-entry', null), _lodash2.default.get(this.options, 'webpack-dev-entries', null));
