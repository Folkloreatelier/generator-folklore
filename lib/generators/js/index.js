        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.yarnInstall(['domready@latest', 'fastclick@latest', 'hoist-non-react-statics@latest', 'hypernova@latest', 'immutable@latest', 'invariant@latest', 'keymirror@latest', 'lodash@latest', 'react@latest', 'prop-types@latest', 'react-dom@latest', 'react-redux@latest', 'react-router@3.0.0', 'react-router-scroll@latest', 'react-router-redux@4.0.0', 'redux@latest', 'redux-thunk@latest', 'redux-logger@latest', 'redux-promise@latest', 'redux-devtools@latest', 'redux-devtools-log-monitor@latest', 'redux-devtools-dock-monitor@latest']);
                    ...
                    this.yarnInstall(['babel-eslint@latest', 'eslint@3.19.0', 'eslint-config-airbnb@15.0.2', 'eslint-plugin-import@2.2.0', 'eslint-plugin-jsx-a11y@5.0.1', 'eslint-plugin-react@7.1.0', 'html-webpack-plugin@latest'], {
                        dev: true
                    });
                }
            };
