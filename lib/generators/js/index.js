        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.npmInstall(['babel-plugin-add-module-exports@latest', 'babel-preset-airbnb@latest', 'domready@latest', 'fastclick@latest', 'hoist-non-react-statics@latest', 'hypernova@latest', 'immutable@latest', 'invariant@latest', 'keymirror@latest', 'lodash@latest', 'react@latest', 'prop-types@latest', 'react-dom@latest', 'react-redux@latest', 'history@3.0', 'react-router@3.0', 'react-router-scroll@latest', 'react-router-redux@4.0', 'recompose@latest', 'react-helmet@latest', 'redux@latest', 'redux-thunk@latest', 'redux-logger@latest', 'redux-promise@latest', 'redux-devtools@latest', 'redux-devtools-log-monitor@latest', 'redux-devtools-dock-monitor@latest', 'node-polyglot@latest', 'classnames@latest'], {
                        save: true
                    });

                    if (this.options['webpack-hot-reload']) {
                        this.npmInstall(['react-hot-loader@^3.0.0-beta.7'], {
                            saveDev: true
                        });
                    }
                    ...
                    this.npmInstall(['babel-eslint@latest', 'eslint@3.19.0', 'eslint-config-airbnb@15.0.2', 'eslint-plugin-import@2.6.1', 'eslint-plugin-jsx-a11y@5.1.1', 'eslint-plugin-react@7.1.0', 'html-webpack-plugin@latest'], {
                        saveDev: true
                    });
                }
            };
