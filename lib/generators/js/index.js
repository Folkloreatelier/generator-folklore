        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.npmInstall(['babel-eslint@latest', 'eslint@latest', 'eslint-config-airbnb@latest', 'eslint-plugin-import@latest', 'eslint-plugin-jsx-a11y@latest', 'eslint-plugin-react@latest', 'html-webpack-plugin@latest'], {
                        saveDev: true
                    });
                }
            };
