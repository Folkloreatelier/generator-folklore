        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.npmInstall(['babel-plugin-add-module-exports@latest', 'babel-preset-airbnb@latest', 'domready@latest', 'fastclick@latest', 'hoist-non-react-statics@latest', 'hypernova@latest', 'immutable@latest', 'invariant@latest', 'keymirror@latest', 'lodash@latest', 'react@latest', 'prop-types@latest', 'react-dom@latest', 'react-redux@latest', 'history@3.0', 'react-router@3.0', 'react-router-scroll@latest', 'react-router-redux@4.0', 'redux@latest', 'redux-thunk@latest', 'redux-logger@latest', 'redux-promise@latest', 'redux-devtools@latest', 'redux-devtools-log-monitor@latest', 'redux-devtools-dock-monitor@latest', 'node-polyglot@latest', 'classnames@latest'], {
                        save: true
                    });
