    ...
    _createClass(ComposerPackageGenerator, [{
        ...
        get: function get() {
            return {
                ...
                testsDirectory: function testsDirectory() {
                ...
                tests: function tests() {
                    var featureSrcPath = this.templatePath('Test.php');
                    var featureDestPath = this.destinationPath('tests/Feature/FeatureTest.php');
                    this.fs.copyTpl(featureSrcPath, featureDestPath, {
                        baseClassName: 'Feature'
                    });

                    var unitSrcPath = this.templatePath('Test.php');
                    var unitDestPath = this.destinationPath('tests/Unit/UnitTest.php');
