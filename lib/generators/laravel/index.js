                ...
                prompts: function prompts() {
                    ...
                    if (this.options.db) {
                        if (!this.options['db-name'] || !this.options['db-name'].length) {
                            prompts.push({
                                ...
                                default: function _default(answers) {
                                    var dbName = _this2.options['project-name'] || answers['project-name'];
                        ...
                        if (!this.options['db-user'] || !this.options['db-user'].length) {
                            prompts.push({
                                ...
                                default: function _default(answers) {
                                    var userName = _this2.options['project-name'] || answers['project-name'];
                    ...
                    return this.prompt(prompts).then(function (answers) {
                        ...
                        if (_this2.options.db) {
                            _this2.options['db-name'] = _lodash2.default.get(answers, 'db-name', _this2.options['db-name']);
                            _this2.options['db-user'] = _lodash2.default.get(answers, 'db-user', _this2.options['db-user']);
                            _this2.options['db-password'] = _lodash2.default.get(answers, 'db-password', _this2.options['db-password']) || '';
                            if (!_this2.options['db-password'].length || _this2.options['db-password'] === 'leave empty for auto-generated') {
                                _this2.options['db-password'] = LaravelGenerator.getPassword();
                            }
                        }
                    });
                }
