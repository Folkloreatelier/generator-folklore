        ...
        value: function configuring() {
            ...
            this.composeWith('folklore:build', {
                ...
                options: {
                    ...
                    'browsersync-files': ['config/**/*.php', 'app/**/*.php', 'resources/views/**/*.php', _path2.default.join(tmpPath, 'css/*.css'), _path2.default.join(publicPath, '*.html'), _path2.default.join(publicPath, '**/*.{jpg,png,ico,gif}')],
                    'skip-install': skipInstall,
                    quiet: true
                }
            });
                ...
                prompts: function prompts() {
                    ...
                    if (!this.project_host) {
                        prompts.push({
                            ...
                            default: function _default(answers) {
                                var projectName = _this2.project_name || answers.project_name;
                    ...
                    if (this.options.db) {
                        if (!this.options['db-name'] || !this.options['db-name'].length) {
                            prompts.push({
                                ...
                                default: function _default(answers) {
                                    var dbName = _this2.project_name || answers.project_name;
                        ...
                        if (!this.options['db-user'] || !this.options['db-user'].length) {
                            prompts.push({
                                ...
                                default: function _default(answers) {
                                    var userName = _this2.project_name || answers.project_name;
                    ...
                    return this.prompt(prompts).then(function (answers) {
                        ...
                        if (answers.project_host) {
                            _this2.project_host = answers.project_host;
                        }

                        if (_this2.options.db) {
                            _this2.db_name = _lodash2.default.get(answers, 'db_name', _this2.options['db-name']);
                            _this2.db_user = _lodash2.default.get(answers, 'db_user', _this2.options['db-user']);
                            _this2.db_password = _lodash2.default.get(answers, 'db_password', _this2.options['db-password']) || '';
                            if (!_this2.db_password.length || _this2.db_password === 'leave empty for auto-generated') {
                                _this2.db_password = LaravelGenerator.getPassword();
                            }
                        }
                    });
                }
        ...
        get: function get() {
            return {
                ...
                removeFiles: function removeFiles() {
                    ...
                    var files = ['gulpfile.js', 'package.json', 'webpack.mix.js', 'config/app.php', 'routes/web.php', 'public/css/app.css', 'public/js/app.js', 'resources/assets/sass', 'resources/assets/js', 'resources/assets/js/app.js', 'resources/assets/js/bootstrap.js', 'resources/views/welcome.blade.php'];
                    ...
                    files.forEach(function (file) {
                        ...
                        if (file.match(/\.(jpg|jpeg|gif|png)$/i)) {
                            ...
                            _this5.fs.copyTpl(source, destination, {
                                project_name: _this5.project_name
                            });
                        }
                    });
                }
