        ...
        get: function get() {
            return {
                ...
                removeFiles: function removeFiles() {
                    ...
                    var files = ['gulpfile.js', 'package.json', 'webpack.mix.js', 'config/app.php', 'routes/web.php', 'public/css/app.css', 'public/js/app.js', 'resources/assets/sass', 'resources/assets/js', 'resources/views/welcome.blade.php'];
