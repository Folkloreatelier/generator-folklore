...
module.exports = function (_Generator) {
    ...
    _createClass(NpmPackageGenerator, [{
        ...
        get: function get() {
            return {
                npm: function npm() {
                    this.yarnInstall(['babel-eslint@latest', 'eslint@latest', 'eslint-config-airbnb@latest', 'eslint-plugin-import@latest', 'eslint-plugin-jsx-a11y@latest', 'eslint-plugin-react@latest', 'jest@latest'], {
                        dev: true
                    });
                }
            };
