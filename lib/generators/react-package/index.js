        ...
        get: function get() {
            return {
                ...
                webpackConfig: function webpackConfig() {
                    ...
                    var configDestPath = this.destinationPath(_path2.default.join(buildPath, 'webpack.config.js'));
                    ...
                    // Browser sync
                    var configBrowsersyncSrcPath = this.templatePath('webpack.config.browsersync.js');
                    var configBrowsersyncDestPath = this.destinationPath(_path2.default.join(buildPath, 'webpack.config.browsersync.js'));
