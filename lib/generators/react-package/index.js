    ...
    _createClass(ReactPackageGenerator, [{
        ...
        get: function get() {
            return {
                ...
                storybook: function storybook() {
                    var srcPath = this.templatePath('storybook');
                    var destPath = this.destinationPath('.storybook');
                    this.fs.copyTpl(srcPath, destPath, {});
                },
        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.yarnInstall(['react@latest', 'prop-types@latest', 'react-dom@latest']);

                    this.yarnInstall(['domready@latest', 'jquery@latest', 'enzyme@latest', 'react-test-renderer@latest', '@storybook/react@latest', '@storybook/addon-actions@latest', 'extract-text-webpack-plugin@latest', 'html-webpack-plugin@latest'], {
                        dev: true
                    });
                }
            };
