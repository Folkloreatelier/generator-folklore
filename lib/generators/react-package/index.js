        ...
        get: function get() {
            return {
                npm: function npm() {
                    ...
                    this.npmInstall(['domready@latest', 'jquery@latest', 'enzyme@latest', 'react-test-renderer@latest', '@kadira/storybook@latest', 'extract-text-webpack-plugin@latest', 'html-webpack-plugin@latest'], {
                        saveDev: true
                    });
                }
            };
