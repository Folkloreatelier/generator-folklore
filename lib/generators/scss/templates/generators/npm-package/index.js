...
module.exports = Generator.extend({
    ...
    configuring: function configuring() {
        ...
        var browserSyncBaseDir = _.get(this.options, 'browsersync-base-dir') || [tmpPath, srcPath];
        var browserSyncFiles = _.get(this.options, 'browsersync-files') || [path.join(srcPath, '*.html')];
