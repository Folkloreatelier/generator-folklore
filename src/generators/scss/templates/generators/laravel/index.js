...
module.exports = Generator.extend({
    ...
    configuring: function configuring() {
        ...
        this.composeWith('folklore:build', {
            ...
            options: {
                ...
                'browsersync-files': ['config/**/*.php', 'app/**/*.php', 'resources/views/**/*.php', path.join(tmpPath, 'css/*.css'), path.join(publicPath, '*.html'), path.join(publicPath, '**/*.{jpg,png,ico,gif}')],
                'skip-install': skipInstall,
                'quiet': true
            }
        });
    ...
    _safeDbString: function _safeDbString(str) {
